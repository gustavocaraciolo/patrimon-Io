...
public class ImovelResourceIT {
    ...
    private static final LocalDate DEFAULT_DIA_PREFERENCIAL_PGMT = LocalDate.ofEpochDay(0L);
    private static final LocalDate UPDATED_DIA_PREFERENCIAL_PGMT = LocalDate.now(ZoneId.systemDefault());
    ...
    public static Imovel createEntity(EntityManager em) {
        Imovel imovel = new Imovel()
            ...
            .diaPreferencialPgmt(DEFAULT_DIA_PREFERENCIAL_PGMT);
        return imovel;
    }
    /**
    ...
    public static Imovel createUpdatedEntity(EntityManager em) {
        Imovel imovel = new Imovel()
            ...
            .diaPreferencialPgmt(UPDATED_DIA_PREFERENCIAL_PGMT);
        return imovel;
    }
    ...
    public void createImovel() throws Exception {
        ...
        assertThat(testImovel.getDiaPreferencialPgmt()).isEqualTo(DEFAULT_DIA_PREFERENCIAL_PGMT);
    }
    ...
    public void getAllImovels() throws Exception {
        ...
        restImovelMockMvc.perform(get("/api/imovels?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].diaPreferencialPgmt").value(hasItem(DEFAULT_DIA_PREFERENCIAL_PGMT.toString())));
    }
    ...
    public void getImovel() throws Exception {
        ...
        restImovelMockMvc.perform(get("/api/imovels/{id}", imovel.getId()))
            ...
            .andExpect(jsonPath("$.diaPreferencialPgmt").value(DEFAULT_DIA_PREFERENCIAL_PGMT.toString()));
    }
    @Test
    @Transactional
    ...
    public void updateImovel() throws Exception {
        ...
        assertThat(testImovel.getDiaPreferencialPgmt()).isEqualTo(UPDATED_DIA_PREFERENCIAL_PGMT);
    }
