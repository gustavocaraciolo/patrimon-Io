...
export class EditorDemoComponent implements OnInit {
  ...
  onTextChange(): void {
    this.messageService.add({ severity: 'info', summary: 'The editor text is changed' });
  }

  onSelectionChange(): void {
    this.messageService.add({ severity: 'info', summary: 'The editor selected text is changed' });
  }
