...
export class ChipsDemoComponent implements OnInit {
  ...
  onAddContact(): void {
    this.messageService.add({ severity: 'info', summary: 'The contact is added' });
  }

  onRemoveContact(): void {
    this.messageService.add({ severity: 'info', summary: 'The contact is removed' });
  }

  onContactClick(): void {
    this.messageService.add({ severity: 'info', summary: 'The contact is clicked' });
  }
